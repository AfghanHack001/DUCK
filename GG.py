...
def reg():
    ...
    jalan('  EASYPAISA ACCOUNT NO (03259369261) ')
    jalan('  EASYPAISA ACCOUNT NAME (LAdy name) ')
    ...
    r = requests.get('https://raw.githubusercontent.com/AfghanHack001/DUCK/main/public.txt').text
    if to in r:
...
def reg2():
    ...
    os.system('xdg-open https://wa.me/+923333989509')
